...
local function createMenu()
  ...
  menu.Name = "Menu"
  menu.Size = UDim2.new(0, 420, 0, 480)
  menu.Position = UDim2.new(0.5, -210, 0.5, -240)
  ...
  colorTitle.Position = UDim2.new(0, 15, 0, 235)
  ...
  createColorPicker("ESP Color:", 270, Config.ESPColor, function(color)
    Config.ESPColor = color
  end)
  
  createColorPicker("FOV Color:", 340, Config.FOVColor, function(color)
